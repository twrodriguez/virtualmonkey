...
@domain="virtualmonkey_awsdns_new"
...
29.times do |num|
  ...
  attributes=
      {"SLAVE_DB_DNSID"=>["text:Z3AINKOIEY1X3X:testslave#{num}.aws.rightscale.com"],
       ...
       "sys_dns/id"=>["text:Z3AINKOIEY1X3X:test#{num}.aws.rightscale.com"],
       "DNS_USER"=>["cred:AWS_ACCESS_KEY_ID_TEST"],
       "sys_dns/user"=>["cred:AWS_ACCESS_KEY_ID_TEST"],
       "DNS_PASSWORD"=>["cred:AWS_SECRET_ACCESS_KEY_TEST"],
       "sys_dns/password"=>["cred:AWS_SECRET_ACCESS_KEY_TEST"],
       "DNS_PROVIDER"=>["text:AwsDNS"],
       "owner"=>["available"],
       "db_mysql/fqdn"=>["text:test#{num}.aws.rightscale.com"],
