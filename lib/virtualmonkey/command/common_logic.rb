...
#        @@options[:cloud_variables].each { |cvpath| @@dm.load_cloud_variables(cvpath) }
    ...
    def self.release_all_dns_domains(deploy_href)
      ["virtualmonkey_shared_resources", "virtualmonkey_awsdns", "virtualmonkey_dyndns", "virtualmonkey_shared_resources_new", "virtualmonkey_awsdns_new", "virtualmonkey_dyndns_new"].each { |domain|
        begin
